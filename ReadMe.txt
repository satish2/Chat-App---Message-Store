This Android App has a text input area where user can type messages. Then a save button to the side, to save the message in the ListView below this EditText view.
